...
Long compname;
%>
<%compname=Long.parseLong(request.getParameter("id")); %>
<body>
 <div class="bread-crumb">
	<ol class="breadcrumb">
	  <li><a href="#">首页</a></li>
	  <li><a href="#">基本信息管理</a></li>
	  <li class="active">运输公司信息编辑</li>
	</ol>
</div>
<hr />
  
<form action="<%=basePath %>addTransport?type=edit" onsubmit="return check()" method="post">
 <div class="function-panel">
	<table class="table table-bordered table-hover">
		...
		<tr>
		<td>公司id</td>
			<td><input type="text" name="compname" id="compname" value="<%=compname %>" readonly/></td></tr>
		<tr>
			<td>负责人</td>
