			...
			<form id="form1" class="form-horizontal" name="form1" method="post"
				...
				<p>
					...
					<input name="receive_text" type="text" id="receive_text" size="30"
						maxlength="20"  readonly="readonly" value="${detailmessage.send_emp_id}"/>
				...
				<p>
					<textarea name="receive_text_area_name" id="receive_text_area_id">
				...
				<div class="form-group">
					<div class="col-sm-2">
						<button type="submit" class="btn btn-default" name="flag"  value="标记已阅读" id="" >
							标记已阅读
						</button>
					</div>
					<div>
						<button type="button" class="btn btn-default" name="back" type="button" id="" onclick="lastPage()">
							返回
						</button>
					</div>
				</div>
