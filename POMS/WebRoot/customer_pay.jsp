...
<body>
	...
	<form class="form-horizontal" action="bigClientManager_PayServlet?arg=query" method="post" name="form1" onsubmit="return chkety()">
		<br/>
		...
		<table width="1000px" style="margin-top:10px" class="table table-bordered table-hover">
				...
				<tr>
					...
					<td>
						<a href="<%=basePath %>bigClientManager_PayServlet?arg=toupdate&customer_name=${user.customer_name }&order_id=${user.order_id }&paied_money=${user.paied_money }&pub_money=${user.pub_money }&pub_need_num=${user.pub_need_num }&customer_id=${user.customer_id }">缴款</a>
					</td>
				</tr>
				</c:forEach>
		</table>
